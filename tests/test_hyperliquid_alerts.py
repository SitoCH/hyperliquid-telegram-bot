...
async def test_check_profit_high_available_balance(mock_hyperliquid_info, mock_telegram_utils, mock_context):
    with patch('hyperliquid_alerts.telegram_utils', mock_telegram_utils):
        # Set the lazy-loaded _info attribute directly
        original_info = hyperliquid_utils._info
        hyperliquid_utils._info = mock_hyperliquid_info
        try:
            # Setup mock response
            ...
            hyperliquid_utils._info = original_info
