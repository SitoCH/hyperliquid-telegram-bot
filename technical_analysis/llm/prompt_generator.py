...
class LLMPromptGenerator:
    ...
    def generate_prediction_prompt(
        ...
        prompt_parts.extend([
            ...
            "",
            "BALANCED MANDATE: Recommend LONG and SHORT trades equally when setups warrant with 70%+ win probability. Default to HOLD only when no clear directional bias exists.",
            "CRITICAL: Do not favor LONG over SHORT signals - treat bearish setups with equal weight and urgency.",
            "",
            ...
            "4. MOMENTUM CONFIRMATION: RSI 45-65 range with clear directional bias OR breaking from oversold/overbought extremes",
            ...
            "- Low volume (<75% of average) during setup formation",
            "- BB_width contracting severely (squeeze) without ANY directional bias",
            "- Recent major news or event within 1 hour affecting market structure",
            "- Price action choppy (multiple false breakouts in last 5 hours)",
            "",           
            "=== ENHANCED INDICATOR ANALYSIS FRAMEWORK ===",
            "",
            "OSCILLATOR ANALYSIS (All indicators must be evaluated):",
            "1. RSI (Directional bias analysis):",
            "   - LONG bias: RSI 50-65 with positive momentum or breaking above 45 from oversold",
            "   - SHORT bias: RSI 35-50 with negative momentum or breaking below 55 from overbought",
            ...
            "   - LONG support: Price bouncing from Fib levels in uptrend or major correction",
            "   - SHORT resistance: Price rejected at Fib levels in downtrend or major rally",
            ...
            "   - LONG setup: Price above cloud (above both Senkou Span A and B) with momentum",
            "   - SHORT setup: Price below cloud (below both Senkou Span A and B) with momentum",
            "   - Neutral zone: Price inside cloud = wait for breakout direction",
            "",
            "2. Ichimoku Lines:",
            ...
            "+ ROC momentum acceleration (positive for LONG, negative for SHORT)",
            "+ Ichimoku cloud breakout (price above cloud for LONG, below cloud for SHORT)",
            "+ Volume ratio confirmation (>1.4 during setup formation)",
            "+ Funding rate mean reversion setup (extreme readings reversing toward opposite direction)",
            "+ EMA/VWAP reclaim (above for LONG) or breakdown (below for SHORT) with sustained follow-through",
            "",
            "PENALTY FACTORS:",
            ...
            "- confidence ≥0.8: Only for setups with 10+ points and almost perfect Tier 1 alignment",
            ...
            "}",            "",
            "EXECUTION MANDATE:",
            "- BE DIRECTIONALLY BALANCED: Aim for 20-30% of analyses resulting in LONG/SHORT signals",
