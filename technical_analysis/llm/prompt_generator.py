...
class LLMPromptGenerator:
    ...
    def generate_prediction_prompt(
        ...
        prompt_parts.extend([
            ...
            "FOCUS: Provide actionable trading insights for immediate entry with 3-4 hour holding potential.",
            "",            "KEY ANALYSIS AREAS:",
            "1. EARLY MOMENTUM SIGNALS: Look for momentum building BEFORE price breakouts - divergences, volume accumulation, oscillator alignments",
            "2. STRUCTURE BREAKS: Price approaching key levels with volume building - identify potential breakout/breakdown setups",
            "3. MULTI-TIMEFRAME CONFLUENCE: Higher timeframe bias with lower timeframe entry signals (15m/30m entries aligned with 1h/4h trend)",
            "4. VOLUME PATTERN ANALYSIS: Volume leading price (accumulation/distribution), volume spikes, volume divergences",
            "5. MOMENTUM SHIFT DETECTION: RSI/Stochastic turning from extremes, MACD histogram changes, Williams %R reversals",
            "6. BOLLINGER BAND DYNAMICS: Squeeze/expansion patterns, band walks, position relative to bands for breakout potential",
            "7. ICHIMOKU EARLY SIGNALS: Tenkan/Kijun alignment, price approaching cloud boundaries, Chikou Span clearance",
            "8. OSCILLATOR DIVERGENCES: Hidden/regular divergences between price and RSI/MACD/Stochastic indicating momentum shifts",
            "9. EMA/VWAP RECLAIMS: Price reclaiming key moving averages with volume confirmation for trend changes",
            "10. FIBONACCI CONFLUENCE: Multiple Fib levels creating support/resistance zones, price reaction at key levels",
            "11. PIVOT POINT INTERACTIONS: Price behavior at pivot levels, multiple touches creating stronger levels",
            "12. FUNDING RATE EXTREMES: Extreme funding creating contrarian pressure for potential reversals",
            "13. WYCKOFF PHASE TRANSITIONS: Signs of phase changes - accumulation ending, markup beginning, distribution signs",            "",
            "EARLY SIGNAL DETECTION FRAMEWORK:",
            "- MOMENTUM DIVERGENCES: RSI/MACD making higher lows while price makes lower lows (bullish) or vice versa",
            "- VOLUME ACCUMULATION: Volume increasing while price consolidates - accumulation before breakout",
            "- OSCILLATOR ALIGNMENT: Multiple oscillators (RSI, Stochastic, Williams %R) converging in same direction",
            "- STRUCTURE PREPARATION: Price approaching key S/R with momentum building, not after breakout",
            "- CONFLUENCE ZONES: Multiple timeframes and indicators aligning at same levels",
            "- SQUEEZE PATTERNS: Bollinger Band squeeze with momentum building for expansion",
            "- ICHIMOKU SIGNALS: Tenkan/Kijun cross before price breaks cloud, early cloud twist signals",
            "- FUNDING EXTREMES: Extreme funding rates creating contrarian setups before reversals",
            "",
            "SIGNAL STRENGTH SCORING (minimum 3 points for actionable signal):",
            "+ Multi-timeframe alignment (1-2 points)",
            "+ Volume confirmation/divergence (1 point)",
            "+ Oscillator confluence (1 point)",
            "+ Key level approach with momentum (1 point)",
            "+ Funding rate extreme/divergence (1 point)",
            "+ BB squeeze/expansion pattern (1 point)",
            "- Conflicting signals (-2 points)",
            "- Extreme volatility without setup (-1 point)",
            "",
            "TRADING REQUIREMENTS:",
            "- Recommend LONG/SHORT only with early setup signals (3+ confluence points)",
            "- Focus on signals BEFORE major moves, not confirmations AFTER",
            "- Target 3-4 hour position holding period for optimal risk/reward",
            "- Minimum 1:1.5 risk/reward ratio required",
            "- MANDATORY: Always provide stop_loss and take_profit for ALL signals",
            "- Stop loss and take profit must be at least 1.5% away from current price",
            "- If technical levels are closer than 1.5%, use the next significant level beyond this threshold",
            "- For uncertain markets: Use HOLD with defensive stop loss/take profit based on key technical levels",
            "",
            "=== RESPONSE FORMAT ===",
            "Provide your analysis in JSON format with complete trade setup details:",
            "CRITICAL: ALL fields below are MANDATORY - never leave stop_loss or take_profit empty:",
            "",
            "{",
            '  "recap_heading": "Brief 1-line market state summary",',
            '  "trading_insight": "Your IMMEDIATE actionable trade - what to do RIGHT NOW in 3 or 4 sentences. If no clear setup exists, say \'wait for [specific condition]\'. Be direct about current price action with some basic context",',
            ...
            "}",
            "",            "EXECUTION RULES:",
            "- EARLY ENTRY: Focus on signals that develop BEFORE major moves - look for momentum building, not momentum confirming",
            "- ANTICIPATION: Identify setups approaching key levels with confluence building, not after breakouts/breakdowns",
            "- CONFLUENCE PRIORITY: Multiple indicators/timeframes must align for early signal confirmation",
            "- SIGNAL TIMING: Enter on early setups within 5-30 minutes, hold positions for 3-4 hours",
            "- CONFIDENCE ≥0.7: Only for confirmed early setup signals with 3+ confluence points",
            "- CRITICAL: NEVER submit response without stop_loss and take_profit values",
            "",
            "SIGNAL REQUIREMENTS:",
            "",
            "FOR LONG/SHORT SIGNALS (actionable trades):",
            "- STOP LOSS: ALWAYS required - logical technical level (S/R, Fibonacci, pivot, ATR-based)",
            "- TARGET PRICE: ALWAYS required - next key level or measured move target", 
            "- RISK/REWARD: Minimum 1:1.5 ratio required",
            "- ENTRY STRATEGY: Required - specify order type and timing",
            "- INVALIDATION LEVEL: Always required - price where trade setup fails",
            "- ACTION FIELD: 'long' or 'short' (indicating position direction)",
            "",
            "FOR HOLD SIGNALS (no immediate trade):",
            "- STOP LOSS: Defensive level based on nearest major S/R (minimum 1.5% away)",
            "- TAKE PROFIT: Next significant technical level in anticipated direction (minimum 1.5% away)",
            "- ACTION FIELD: 'none' (no position change)",
            "- ENTRY STRATEGY: 'wait' or 'monitor' - explain what condition to wait for",
            "- Use HOLD when: No clear setup exists OR conflicting signals OR waiting for confirmation",
            "",
