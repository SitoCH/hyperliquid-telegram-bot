...
_TIMEFRAME_SETTINGS = {
    Timeframe.MINUTES_15: TimeframeSettings(
        ...
        high_threshold=0.75,
        low_threshold=0.78,
        wyckoff_volatility_factor=0.75,
        wyckoff_trend_lookback=4,
        wyckoff_lps_volume_threshold=0.16,
        wyckoff_lps_price_multiplier=0.52,
        wyckoff_sos_multiplier=1.03,
        wyckoff_ut_multiplier=0.28,
        wyckoff_sc_multiplier=1.03,
        wyckoff_ar_multiplier=0.93,
        wyckoff_confirmation_threshold=0.26,
    ),
    Timeframe.MINUTES_30: TimeframeSettings(
        ...
        atr_multiplier=0.22,
        volume_weighted_efficiency=0.32,
        high_threshold=0.80,
        low_threshold=0.78,
        ...
        wyckoff_sos_multiplier=1.06,
        wyckoff_ut_multiplier=0.34,
        wyckoff_sc_multiplier=1.06,
        wyckoff_ar_multiplier=0.98,
        wyckoff_confirmation_threshold=0.29,
    ),
    Timeframe.HOUR_1: TimeframeSettings(
        ...
        wyckoff_lps_price_multiplier=0.66,
        wyckoff_sos_multiplier=1.14,
        wyckoff_ut_multiplier=0.38,
        wyckoff_sc_multiplier=1.16,
        wyckoff_ar_multiplier=1.04,
